...
interface CombinedFormPayload {
  name: string;
  code: string;
  total_duration_minutes?: number | null;
  is_active: boolean;
  items: { service_id: number; position: number; offset_minutes: number; duration_minutes: number | null }[];
}

interface CombinedServiceFormModalProps {
  open: boolean;
  onClose: () => void;
