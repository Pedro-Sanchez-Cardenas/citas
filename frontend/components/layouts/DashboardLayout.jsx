...
export default function DashboardLayout({ user, onLogout, children }) {
  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      {/* Sidebar desktop */}
      <aside className="relative z-20 hidden h-screen w-64 flex-col border-r border-slate-800/90 bg-slate-950/80 px-5 pb-5 pt-6 backdrop-blur-2xl lg:flex lg:min-h-0 lg:overflow-hidden">
