...
export async function fetchServiceCategory(id: number | string): Promise<unknown | null> {
...
export async function deleteServiceCategory(id: number | string): Promise<unknown> {
