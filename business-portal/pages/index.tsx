  ...
  return (
    <AuthLayout>
      <div className="mb-8 w-full max-w-md text-center md:mb-0 md:max-w-lg md:text-left">
        <p className="inline-flex items-center gap-2 rounded-full border border-teal-500/30 bg-teal-500/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.12em] text-teal-200">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 text-sm text-slate-300 sm:grid-cols-2">
          <div className="flex items-start gap-2">
            <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-teal-500/20 text-[11px] text-teal-300">
              ✓
            </span>
            <p>Agenda diaria clara para todo el equipo.</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-cyan-500/20 text-[11px] text-cyan-300">
              ✓
            </span>
